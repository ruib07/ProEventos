...
export class RedesSociaisComponent implements OnInit {
  ...
  public guardarRedesSociais(): void {
    let origem = 'palestrante';
    ...
    if (this.formRS.controls.redesSociais.valid) {
      this.redeSocialService
        ...
        .subscribe(
          () => {
            this.toastr.success(
              'Redes Sociais guardadas com Sucesso!',
              'Sucesso!'
            );
          },
          (error: any) => {
            this.toastr.error('Erro ao tentar guardar Redes Sociais.', 'Erro');
            console.error(error);
          }
        );
    }
  ...
  confirmDeleteRedeSocial(): void {
    ...
    this.redeSocialService
      ...
      .subscribe(
        ...
        (error: any) => {
          this.toastr.error(
            `Erro ao tentar remover o Rede Social ${this.redeSocialAtual.id}`,
            'Erro'
          );
          console.error(error);
        }

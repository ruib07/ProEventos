...
namespace ProEventos.API.Controllers
{
    ...
    public class RedesSociaisController : ControllerBase
    {
        ...
        public RedesSociaisController(IRedeSocialService redeSocialService, IEventoService eventoService,
        ...
        public async Task<IActionResult> SaveByEvento(int eventoId, RedeSocialDto[] models)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, 
                $"Erro ao tentar guardar Rede Social por evento. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> SaveByPalestrante(RedeSocialDto[] models)
        {
            ...
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, 
                $"Erro ao tentar guardar Rede Social por palestrante. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> DeleteByEvento(int eventoId, int redeSocialId)
        {
            try
            {
                ...
                return Ok(new {
                    message = "Rede Social Eliminada" 
                });
                else
                {
                    throw new Exception("Ocorreu um problema não específico ao tentar eliminar a Rede Social por evento.");
                }
            }
            catch (Exception ex)
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, 
                $"Erro ao tentar eliminar rede social por evento. Erro: {ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> DeleteByPalestrante(int redeSocialId)
        {
            try
            {
                ...
                {
                    throw new Exception("Ocorreu um problema não específico ao tentar eliminar a Rede Social por palestrante.");
                }
            }
            catch (Exception ex)
            {
                return this.StatusCode(StatusCodes.Status500InternalServerError, 
                $"Erro ao tentar eliminar rede social por palestrante. Erro: {ex.Message}");
            }
        }

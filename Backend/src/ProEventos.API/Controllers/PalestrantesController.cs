...
namespace ProEventos.API.Controllers
{
    ...
    public class PalestrantesController : ControllerBase
    {
        ...
        public PalestrantesController(IPalestranteService palestranteService, IWebHostEnvironment hostEnvironment,
        ...
        public async Task<IActionResult> GetAll([FromQuery]PageParams pageParams)
        {
            try
            {
                ...
                Response.AddPagination(palestrantes.CurrentPage, palestrantes.PageSize, palestrantes.TotalCount,
